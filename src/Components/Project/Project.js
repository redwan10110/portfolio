        ...
        <div class=" w-full bg-transparent ">
          <div class="carousel w-full lg:h-full h-64">
            <div id="slide1" class="carousel-item relative w-full">
              <img src={saw1} class="w-full" alt="hii" />
            ...
            <div id="slide2" class="carousel-item relative w-full">
              <img src={saw2} class="w-full" alt="hi3" />
              <div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
            ...
            <div id="slide3" class="carousel-item relative w-full">
              <img src={saw3} class="w-full" alt="hi2" />
              <div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                <a href="#slide2" class="btn btn-circle btn-outline">
                  ❮
                </a>
            ...
            <div id="slide4" class="carousel-item relative w-full">
              <img src={saw4} class="w-full" alt="hi2" />
              <div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                <a href="#slide3" class="btn btn-circle btn-outline">
                  ❮
                </a>
            ...
            <div id="slide5" class="carousel-item relative w-full">
              <img src={saw5} class="w-full" alt="hi2" />
              <div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                <a href="#slide4" class="btn btn-circle btn-outline">
                  ❮
                </a>
            ...
            <div id="slide6" class="carousel-item relative w-full">
              <img src={saw6} class="w-full" alt="hi2" />
              <div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                <a href="#slide5" class="btn btn-circle btn-outline">
                  ❮
                </a>
        ...
        <div class="w-full bg-transparent ">
          <div class="card-body">
            ...
            <p className="text-base text-white">
              This is a website for saw manufacturer. Where an user can buy
              product in bulk. Admin Panel Has implemented. An admin can perform
              CRUD operation
            </p>
            ...
            <div class="card-actions justify-start mt-8">
              <button
                class="btn btn-outline btn-info text-white"
                onClick={() =>
                  window.open(
      ...
      <div className="grid lg:grid-cols-2 gap-2 grid-cols-1 border border-sky-500 rounded-xl overflow-hidden my-7">
        ...
        <div class=" w-full bg-transparent ">
          <div class="carousel w-full lg:h-full h-64">
            <div id="slide11" class="carousel-item relative w-full">
              <img src={ainjibi1} class="w-full" alt="hii" />
              <div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
            ...
            <div id="slide12" class="carousel-item relative w-full">
              <img src={ainjibi2} class="w-full" alt="hi3" />
              <div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
            ...
            <div id="slide13" class="carousel-item relative w-full">
              <img src={nature1} class="w-full" alt="hi2" />
              <div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                <a href="#slide12" class="btn btn-circle btn-outline">
                  ❮
                </a>
        ...
        <div class="w-full bg-transparent ">
          <div class="card-body">
            ...
            <p className="text-base text-white">
              This is a website for an advocate who provides various kinds of
              law services to his client.
            </p>
            <h2 className="text-secondary font-bold">Tech Stack</h2>
            <div className="flex flex-wrap gap-3">
              <div className="py-1 px-2  rounded-lg cursor-pointer text-white bg-blue-500">
            ...
            <div class="card-actions justify-start mt-8">
              <button
                class="btn btn-outline btn-info text-white"
                onClick={() =>
                  window.open("https://lawyer-43f05.web.app/", "_blank")
                }
              >
                Live
              </button>
        ...
        <div class=" w-full bg-transparent ">
          <div class="carousel w-full lg:h-full h-64">
            <div id="slide31" class="carousel-item relative w-full">
              <img src={nature1} class="w-full" alt="hii" />
              <div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
            ...
            <div id="slide32" class="carousel-item relative w-full">
              <img src={nature2} class="w-full" alt="hi3" />
              <div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
            ...
            <div id="slide33" class="carousel-item relative w-full">
              <img src={nature3} class="w-full" alt="hi2" />
              <div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                <a href="#slide32" class="btn btn-circle btn-outline">
                  ❮
                </a>
        ...
        <div class="w-full bg-transparent ">
          <div class="card-body">
            <h2 class="card-title text-white text-2xl font-bold">
              Natours-Project Live
            </h2>
            <p className="text-base text-white">
              This is a travel website where users can book an event. This
              website has made based on Sass and BEM Methodology.
            </p>
            <h2 className="text-secondary font-bold">Tech Stack</h2>
            <div className="flex flex-wrap gap-3">
              <div className="py-1 px-2  rounded-lg cursor-pointer text-white bg-blue-500">
